...
// In this file, you will have the resume templates and dummy data for the resume.
// The `resumeTemplates` array contains objects with template IDs, thumbnail images, and color palette
