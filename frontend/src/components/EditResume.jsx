...
const EditResume = () => {
  ...
  // Function to go back to the previous step on or the dashboard
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  // Update the section of the resume data
  ...
  // Add a new item to an array section of the resume data
  ...
  // Remove an item from an array section of the resume data
...
// It will help in choosing the preview as well as helps in downloading the resume also save the resume as a image.
  ...
  // this function will help in updating the resume details after uploading the images.
...
// Function to download the resume as a PDF
  // It will help in downloading the resume as a PDF file.
  ...
  // Update the theme of the resume
  // It will help in choosing the preview as well as helps in downloading the resume also save the resume as a image.
  ...
  // So all this function will be used for the editing the resume.
  ...
  return (
    <DashboardLayout>
        ...
        showActionBtn
        actionBtnText={isDownloading ? "Downloading..." : "Download PDF"}
